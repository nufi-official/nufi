...
Therefore this method is not suitable for obtaining social login info immediately after connecting. Instead its more suited for reaching to social login info as a response to some user interaction when the info is already defined, without the need to store/read it from some other store.
...
<figure><img src="../../../.gitbook/assets/button-position-2.png" alt="" width="375"><figcaption><p>Login button inside Wallet options</p></figcaption></figure>
